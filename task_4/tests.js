...
// <li>Необходимо в div с id photo вставить фото по центру и масштабировать его максимально, но чтобы картинка не сплющивалась, а обрезалась (значение cover).</li>
	...
	{
		"msg": 'Необходимо в section с id pullover задать повторяющуюся часть текстуры, которая повторениями закрывает область по горизонтали.',
		"tag": 'section',
		"class": undefined,
		"id": 'pullover',
		'styleList': {
	...
	{
		"msg": 'Необходимо в section с id bike реализовать темно-зеленый фон (darkgreen) и вставить картинку велосипеда в нижний левый угол.',
		"tag": 'section',
		"class": undefined,
		"id": 'bike',
		'styleList': {
